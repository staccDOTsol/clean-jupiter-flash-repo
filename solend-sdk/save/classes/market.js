...
class SolendMarket {
    ...
    loadRewards() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.rewardsData = this.reserves.reduce((acc, reserve) => {
                const supply = [
                    ...externalRewards
                        .filter((externalReward) => externalReward.reserveID === reserve.address &&
                ...
                return Object.assign(Object.assign({}, acc), { [reserve.mint]: {
                        supply,
                        borrow,
                    } });
            }, {});
    ...
    loadReserves() {
        return __awaiter(this, void 0, void 0, function* () {
            const addresses = this.reserves.map((reserve) => new web3_js_1.PublicKey(reserve.address));
