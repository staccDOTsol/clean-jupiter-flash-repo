...
exports.openbookRoute = exports.getOutAmount = exports.forecastSell = exports.forecastBuy = void 0;
...
function openbookRoute(fromCoin, toCoin, fromCoinAmount, option, liquidityData, settings) {
    let marketConfig = liquidityData.openbookData[option.ownAddress.toBase58()];
...
exports.openbookRoute = openbookRoute;
